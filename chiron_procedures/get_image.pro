...
if namps eq 4 then begin
     ...
     ;#####################################################	  
	   if redpar.biasmode eq 0 then begin ; It substracts the trim + master bias
		   ...
		   im[idx[0]:idx[1], idx[2]:idx[3]] -= median(im[geom.bias_trim.upleft[0]:geom.bias_trim.upleft[1], geom.bias_trim.upleft[2]:geom.bias_trim.upleft[3]])
		   ...
		   im[idx[0]:idx[1], idx[2]:idx[3]] -= median(im[geom.bias_trim.upright[0]:geom.bias_trim.upright[1], geom.bias_trim.upright[2]:geom.bias_trim.upright[3]])
		   
		  ;3. and the bottom left quadrant:
		   idx = [0L, geom.bias_full.botleft[1], geom.image_trim.botleft[2], geom.image_trim.botleft[3]]
		   im[idx[0]:idx[1], idx[2]:idx[3]] -=  median(im[geom.bias_trim.botleft[0]:geom.bias_trim.botleft[1], geom.bias_trim.botleft[2]:geom.bias_trim.botleft[3]])
       ...
       ;print, 'The UPPER LEFT part of the image is getting trimmed as '
       ;print, ' Cross Dispersion direction  [ ' +string(geom.image_trim.upleft[0]) +':'+ string(geom.image_trim.upleft[1]) + ' ] '
       ;print, ' AlongDispersion direction  [ ' +string(geom.image_trim.upleft[2]) +':'+string(geom.image_trim.upleft[3]) + ' ] '
       ...
       ;print, 'The UPPER RIGHT part of the image is getting trimmed as '
       ;print, ' Cross Dispersion direction  [ ' +string(geom.image_trim.upright[0]) +':'+ string(geom.image_trim.upright[1]) + ' ] '
       ;print, ' AlongDispersion direction  [ ' +string(geom.image_trim.upright[2]) +':'+string(geom.image_trim.upright[3])+ ' ]
       ...
       ;print, 'The BOTTOM LEFT part of the image is getting trimmed as '
       ;print, ' Cross Dispersion direction  [ ' +string(geom.image_trim.botleft[0]) +':'+ string(geom.image_trim.botleft[1]) + ' ] '
       ;print, ' AlongDispersion direction  [ ' +string(geom.image_trim.botleft[2]) +':'+string(geom.image_trim.botleft[3])+ ' ]
       ...
       ;print, 'The BOTTOM RIGHT part of the image is getting trimmed as '
       ;print, ' Cross Dispersion direction  [ ' +string(geom.image_trim.botright[0]) +':'+ string(geom.image_trim.botright[1]) + ' ] '
       ;print, ' AlongDispersion direction  [ ' +string(geom.image_trim.botright[2]) +':'+string(geom.image_trim.botright[3])+ ' ]
