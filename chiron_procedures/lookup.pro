...
; changes made.  CMc 1/06
    ...
    ;tycfile = '/mir3/bary/tycho.dat'      ; not used 
    ...
    ; First Check to see if it is in our standard catalog (cat=dum)     ;  This whole section was found commented
    ;-------------------------------------
    ; 
