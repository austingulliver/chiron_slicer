...
;        J. Andres Lozano 2021.01.31
;
;-
pro chi_barystruct, asciifn = asciifn,  structfn = structfn
    ...
    nobs = file_lines(asciifn)   ; number of lines of text contained within the specified file
    bcat_i = create_struct('obsnm', '', 'objnm', '', 	'bc', 0d, 'jd', 0d, 'ha', 0d, 'obtype', '')
                          ; obsnm  : Observation Number 
                          ; objnm  : Object Name
                          ; bc     :
                          ; jd     : 
    bcat = replicate(bcat_i, nobs)    ; Creates an object for every line.
    
    openr, flun, asciifn, /get_lun
    line=''
    for i=0L, nobs-1 do begin
        readf, flun, line        ; Reading line by line 
