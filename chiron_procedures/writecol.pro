; file: writecol.pro
; init: some time ago
; last: Dec 29 2017  Rob Rutten  Deil
...
;
; REVISION HISTORY:
;   17-June-2001 Written by JXP ;RR = J. XAVIER PROCHASKA I think
;   Dec 29 2017 RR: also admit only 1 vector
;-
;-----------------------------------------------------------------------------
